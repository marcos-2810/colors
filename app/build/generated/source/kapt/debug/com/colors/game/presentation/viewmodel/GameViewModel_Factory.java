...
public final class GameViewModel_Factory implements Factory<GameViewModel> {
  ...
  public GameViewModel get() {
    return newInstance(savedStateHandleProvider.get(), levelRepoProvider.get(), gameStateRepoProvider.get(), settingsRepoProvider.get());
  }
  ...
  public static GameViewModel_Factory create(Provider<SavedStateHandle> savedStateHandleProvider,
      ...
      Provider<GameStateRepository> gameStateRepoProvider,
      Provider<SettingsRepository> settingsRepoProvider) {
    return new GameViewModel_Factory(savedStateHandleProvider, levelRepoProvider, gameStateRepoProvider, settingsRepoProvider);
  }

  public static GameViewModel newInstance(SavedStateHandle savedStateHandle,
      LevelRepository levelRepo, GameStateRepository gameStateRepo,
      SettingsRepository settingsRepo) {
    return new GameViewModel(savedStateHandle, levelRepo, gameStateRepo, settingsRepo);
  }
}
