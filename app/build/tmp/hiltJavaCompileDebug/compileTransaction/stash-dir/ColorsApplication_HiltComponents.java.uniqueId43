...
import com.colors.game.di.AppModule;
...
public final class ColorsApplication_HiltComponents {
  private ColorsApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements ColorsApplication_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          LevelSelectorViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          LevelSelectorViewModel_HiltModules.BindsModule.class,
